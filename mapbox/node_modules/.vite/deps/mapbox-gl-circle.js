...
var require_package = __commonJS({
  "node_modules/mapbox-gl-circle/package.json"(exports, module) {
    module.exports = {
...
var require_invariant = __commonJS({
  "node_modules/@turf/invariant/index.js"(exports, module) {
    ...
    function featureOf(feature3, type, name) {
      if (!feature3) throw new Error("No feature passed");
      ...
      if (!feature3.geometry || feature3.geometry.type !== type) {
        throw new Error("Invalid input to " + name + ": must be a " + type + ", given " + feature3.geometry.type);
      }
    }
    function collectionOf(featureCollection, type, name) {
      ...
      for (var i = 0; i < featureCollection.features.length; i++) {
        var feature3 = featureCollection.features[i];
        if (!feature3 || feature3.type !== "Feature" || !feature3.geometry) {
          throw new Error("Invalid input to " + name + ", Feature with geometry required");
        }
        if (!feature3.geometry || feature3.geometry.type !== type) {
...
// node_modules/@turf/destination/node_modules/@turf/helpers/index.js
var require_helpers = __commonJS({
  "node_modules/@turf/destination/node_modules/@turf/helpers/index.js"(exports, module) {
    function feature3(geometry2, properties, bbox, id) {
      if (geometry2 === void 0) throw new Error("geometry is required");
    ...
    function geometry(type, coordinates, bbox) {
      ...
      switch (type) {
        case "Point":
          ...
          break;
        case "LineString":
          geom = lineString3(coordinates).geometry;
          break;
        case "Polygon":
    ...
    function point(coordinates, properties, bbox, id) {
      ...
      if (coordinates.length === void 0) throw new Error("Coordinates must be an array");
    ...
    function lineString3(coordinates, properties, bbox, id) {
      if (!coordinates) throw new Error("No coordinates passed");
    ...
    function round(num, precision) {
      if (num === void 0 || num === null || isNaN(num)) throw new Error("num is required");
    ...
    function distanceToRadians(distance, units) {
      if (distance === void 0 || distance === null) throw new Error("distance is required");
      var factor = factors[units || "kilometers"];
      if (!factor) throw new Error("units is invalid");
    ...
    function bearingToAngle(bearing) {
      if (bearing === null || bearing === void 0) throw new Error("bearing is required");
    ...
    function convertDistance(distance, originalUnit, finalUnit) {
      if (distance === null || distance === void 0) throw new Error("distance is required");
      if (!(distance >= 0)) throw new Error("distance must be a positive number");
      var convertedDistance = radiansToDistance(distanceToRadians(distance, originalUnit), finalUnit || "kilometers");
      return convertedDistance;
    }
    function convertArea(area, originalUnit, finalUnit) {
      if (area === null || area === void 0) throw new Error("area is required");
...
var require_destination = __commonJS({
  "node_modules/@turf/destination/index.js"(exports, module) {
    var getCoord = require_invariant().getCoord;
...
// node_modules/@turf/circle/node_modules/@turf/helpers/index.js
var require_helpers2 = __commonJS({
  "node_modules/@turf/circle/node_modules/@turf/helpers/index.js"(exports, module) {
    function feature3(geometry2, properties, bbox, id) {
      if (geometry2 === void 0) throw new Error("geometry is required");
      if (properties && properties.constructor !== Object) throw new Error("properties must be an Object");
      if (bbox && bbox.length !== 4) throw new Error("bbox must be an Array of 4 numbers");
...
var require_circle = __commonJS({
  "node_modules/@turf/circle/index.js"(exports, module) {
    var destination = require_destination();
    var polygon = require_helpers2().polygon;
...
// node_modules/mapbox-gl-circle/node_modules/@turf/meta/index.js
var meta_exports = {};
...
function coordEach(geojson, callback, excludeWrapCoord) {
  ...
  var featureIndex, geometryIndex, j, k, l, geometry, stopG, coords, geometryMaybeCollection, wrapShrink = 0, coordIndex = 0, isGeometryCollection, type = geojson.type, isFeatureCollection = type === "FeatureCollection", isFeature = type === "Feature", stop = isFeatureCollection ? geojson.features.length : 1;
...
function geomEach(geojson, callback) {
  var i, j, g, geometry, stopG, geometryMaybeCollection, isGeometryCollection, geometryProperties, featureIndex = 0, isFeatureCollection = geojson.type === "FeatureCollection", isFeature = geojson.type === "Feature", stop = isFeatureCollection ? geojson.features.length : 1;
  for (i = 0; i < stop; i++) {
...
function geomReduce(geojson, callback, initialValue) {
  ...
  geomEach(geojson, function(currentGeometry, currentIndex, currentProperties) {
    if (currentIndex === 0 && initialValue === void 0) previousValue = currentGeometry;
...
function flattenReduce(geojson, callback, initialValue) {
  ...
  flattenEach(geojson, function(currentFeature, featureIndex, featureSubIndex) {
    if (featureIndex === 0 && featureSubIndex === 0 && initialValue === void 0) previousValue = currentFeature;
    else previousValue = callback(previousValue, currentFeature, featureIndex, featureSubIndex);
  });
  return previousValue;
}
function segmentEach(geojson, callback) {
  flattenEach(geojson, function(feature3, featureIndex, featureSubIndex) {
    var segmentIndex = 0;
    if (!feature3.geometry) return;
    var type = feature3.geometry.type;
    if (type === "Point" || type === "MultiPoint") return;
    coordReduce(feature3, function(previousCoords, currentCoord) {
      var currentSegment = lineString([previousCoords, currentCoord], feature3.properties);
...
function feature(geometry, properties) {
  if (geometry === void 0) throw new Error("No geometry passed");
  return {
    type: "Feature",
...
function lineReduce(geojson, callback, initialValue) {
  ...
  lineEach(geojson, function(currentLine, lineIndex, lineSubIndex) {
    if (lineIndex === 0 && initialValue === void 0) previousValue = currentLine;
...
// node_modules/mapbox-gl-circle/node_modules/@turf/bbox/index.js
var require_bbox = __commonJS({
  "node_modules/mapbox-gl-circle/node_modules/@turf/bbox/index.js"(exports, module) {
    var coordEach3 = (init_meta(), __toCommonJS(meta_exports)).coordEach;
    module.exports = function(geojson) {
      var bbox = [Infinity, Infinity, -Infinity, -Infinity];
      coordEach3(geojson, function(coord) {
...
var require_helpers3 = __commonJS({
  "node_modules/@turf/bbox-polygon/node_modules/@turf/helpers/index.js"(exports, module) {
    function feature3(geometry2, properties, bbox, id) {
      if (geometry2 === void 0) throw new Error("geometry is required");
      if (properties && properties.constructor !== Object) throw new Error("properties must be an Object");
      if (bbox && bbox.length !== 4) throw new Error("bbox must be an Array of 4 numbers");
...
var require_bbox_polygon = __commonJS({
  "node_modules/@turf/bbox-polygon/index.js"(exports, module) {
    var polygon = require_helpers3().polygon;
...
var meta_exports2 = {};
__export(meta_exports2, {
  coordAll: () => coordAll2,
  coordEach: () => coordEach2,
  coordReduce: () => coordReduce2,
  feature: () => feature2,
  featureEach: () => featureEach2,
  featureReduce: () => featureReduce2,
  flattenEach: () => flattenEach2,
  flattenReduce: () => flattenReduce2,
  geomEach: () => geomEach2,
  geomReduce: () => geomReduce2,
  lineEach: () => lineEach2,
  lineReduce: () => lineReduce2,
  lineString: () => lineString2,
  propEach: () => propEach2,
  propReduce: () => propReduce2,
  segmentEach: () => segmentEach2,
  segmentReduce: () => segmentReduce2
});
  ...
  for (featureIndex = 0; featureIndex < stop; featureIndex++) {
    ...
    for (geometryIndex = 0; geometryIndex < stopG; geometryIndex++) {
      ...
      switch (geomType) {
        ...
        case "GeometryCollection":
          for (j = 0; j < geometry.geometries.length; j++)
            coordEach2(geometry.geometries[j], callback, excludeWrapCoord);
          break;
        default:
          throw new Error("Unknown Geometry Type");
      }
...
function coordReduce2(geojson, callback, initialValue, excludeWrapCoord) {
  var previousValue = initialValue;
  coordEach2(geojson, function(currentCoord, coordIndex, featureIndex, featureSubIndex) {
    if (coordIndex === 0 && initialValue === void 0) previousValue = currentCoord;
    else previousValue = callback(previousValue, currentCoord, coordIndex, featureIndex, featureSubIndex);
  }, excludeWrapCoord);
  return previousValue;
...
function geomReduce2(geojson, callback, initialValue) {
  var previousValue = initialValue;
  geomEach2(geojson, function(currentGeometry, currentIndex, currentProperties) {
    if (currentIndex === 0 && initialValue === void 0) previousValue = currentGeometry;
    else previousValue = callback(previousValue, currentGeometry, currentIndex, currentProperties);
  });
  return previousValue;
...
function flattenEach2(geojson, callback) {
  geomEach2(geojson, function(geometry, featureIndex, properties) {
    var type = geometry === null ? null : geometry.type;
    switch (type) {
      case null:
      case "Point":
      case "LineString":
      case "Polygon":
        callback(feature2(geometry, properties), featureIndex, 0);
        return;
    }
    var geomType;
    switch (type) {
    ...
    geometry.coordinates.forEach(function(coordinate, featureSubIndex) {
      ...
      callback(feature2(geom, properties), featureIndex, featureSubIndex);
    });
  });
}
function flattenReduce2(geojson, callback, initialValue) {
  var previousValue = initialValue;
  flattenEach2(geojson, function(currentFeature, featureIndex, featureSubIndex) {
    if (featureIndex === 0 && featureSubIndex === 0 && initialValue === void 0) previousValue = currentFeature;
    else previousValue = callback(previousValue, currentFeature, featureIndex, featureSubIndex);
  });
  return previousValue;
...
function segmentEach2(geojson, callback) {
  flattenEach2(geojson, function(feature3, featureIndex, featureSubIndex) {
    var segmentIndex = 0;
    if (!feature3.geometry) return;
    var type = feature3.geometry.type;
    if (type === "Point" || type === "MultiPoint") return;
    coordReduce2(feature3, function(previousCoords, currentCoord) {
      var currentSegment = lineString2([previousCoords, currentCoord], feature3.properties);
      callback(currentSegment, featureIndex, featureSubIndex, segmentIndex);
      segmentIndex++;
      return currentCoord;
    });
...
function segmentReduce2(geojson, callback, initialValue) {
  var previousValue = initialValue;
  var started = false;
  segmentEach2(geojson, function(currentSegment, featureIndex, featureSubIndex, segmentIndex) {
    if (started === false && initialValue === void 0) previousValue = currentSegment;
    else previousValue = callback(previousValue, currentSegment, featureIndex, featureSubIndex, segmentIndex);
    started = true;
  });
...
function feature2(geometry, properties) {
  if (geometry === void 0) throw new Error("No geometry passed");
  return {
    type: "Feature",
    properties: properties || {},
...
function lineString2(coordinates, properties) {
  if (!coordinates) throw new Error("No coordinates passed");
  if (coordinates.length < 2) throw new Error("Coordinates must be an array of two or more positions");
  return {
    type: "Feature",
...
function lineReduce2(geojson, callback, initialValue) {
  var previousValue = initialValue;
  lineEach2(geojson, function(currentLine, lineIndex, lineSubIndex) {
    if (lineIndex === 0 && initialValue === void 0) previousValue = currentLine;
    else previousValue = callback(previousValue, currentLine, lineIndex, lineSubIndex);
  });
  return previousValue;
...
var require_truncate = __commonJS({
  "node_modules/@turf/truncate/index.js"(exports, module) {
    var coordEach3 = (init_meta2(), __toCommonJS(meta_exports2)).coordEach;
    module.exports = function(geojson, precision, coordinates, mutate) {
      ...
      coordEach3(geojson, function(coords) {
...
// node_modules/@turf/distance/node_modules/@turf/helpers/index.js
var require_helpers4 = __commonJS({
  "node_modules/@turf/distance/node_modules/@turf/helpers/index.js"(exports, module) {
    function feature3(geometry2, properties, bbox, id) {
      if (geometry2 === void 0) throw new Error("geometry is required");
      if (properties && properties.constructor !== Object) throw new Error("properties must be an Object");
      if (bbox && bbox.length !== 4) throw new Error("bbox must be an Array of 4 numbers");
...
var require_distance = __commonJS({
  "node_modules/@turf/distance/index.js"(exports, module) {
    var getCoord = require_invariant().getCoord;
    var radiansToDistance = require_helpers4().radiansToDistance;
...
var require_bearing = __commonJS({
...
var require_helpers5 = __commonJS({
  "node_modules/mapbox-gl-circle/node_modules/@turf/helpers/index.js"(exports, module) {
    function feature3(geometry2, properties, bbox, id) {
      if (geometry2 === void 0) throw new Error("geometry is required");
      if (properties && properties.constructor !== Object) throw new Error("properties must be an Object");
      if (bbox && bbox.length !== 4) throw new Error("bbox must be an Array of 4 numbers");
...
var require_main = __commonJS({
  "node_modules/mapbox-gl-circle/lib/main.js"(exports, module) {
    var projectVersion = require_package().version;
    var _ = require_lodash();
    var EventEmitter = require_events();
    var turfCircle = require_circle();
    var turfBbox = require_bbox();
    var turfBboxPoly = require_bbox_polygon();
    var turfTruncate = require_truncate();
    var turfDestination = require_destination();
    var turfDistance = require_distance();
    var turfBearing = require_bearing();
    var turfHelpers = require_helpers5();
    ...
    var MapboxCircle = class _MapboxCircle {
      /**
       ...
       */
      get _instanceId() {
        if (this.__instanceId === void 0) {
          this.__instanceId = _MapboxCircle.__MONOSTATE.instanceIdCounter++;
        }
      ...
      constructor(center, radius, options) {
        ...
        this._lastCenterLngLat = [centerLng, centerLat];
        this._editCenterLngLat = [centerLng, centerLat];
        this._currentCenterLngLat = [centerLng, centerLat];
        this._lastRadius = Math.round(radius);
        this._editRadius = Math.round(radius);
        this._currentRadius = Math.round(radius);
      ...
      _updateCircle() {
        ...
        const unit = "meters";
        if (!(this._centerDragActive && radius < 1e4)) {
        ...
        if (this.options.debugEl) {
          this._updateCount += 1;
          this.options.debugEl.innerHTML = "Center: " + JSON.stringify(this.getCenter()) + " / Radius: " + radius + " / Bounds: " + JSON.stringify(this.getBounds()) + " / Steps: " + steps + " / Zoom: " + zoom.toFixed(2) + " / ID: " + this._instanceId + " / #: " + this._updateCount;
        }
      }
      /**
      ...
      _pointOnHandle(point) {
        return !_MapboxCircle.__MONOSTATE.activeEditableCircles.every((circleWithHandles) => {
          const handleLayersAtCursor = this.map.queryRenderedFeatures(
            point,
            { layers: [circleWithHandles._circleCenterHandleId, circleWithHandles._circleRadiusHandlesId] }
          );
      ...
      _suspendHandleListeners(typeOfHandle) {
        _MapboxCircle.__MONOSTATE.broadcast.emit("suspendCenterHandleListeners", this._instanceId, typeOfHandle);
        _MapboxCircle.__MONOSTATE.broadcast.emit("suspendRadiusHandlesListeners", this._instanceId, typeOfHandle);
        _MapboxCircle.__MONOSTATE.broadcast.emit("suspendCircleFillListeners", this._instanceId, typeOfHandle);
      }
      /**
      ...
      _resumeHandleListeners(typeOfHandle) {
        _MapboxCircle.__MONOSTATE.broadcast.emit("resumeCenterHandleListeners", this._instanceId, typeOfHandle);
        _MapboxCircle.__MONOSTATE.broadcast.emit("resumeRadiusHandlesListeners", this._instanceId, typeOfHandle);
        _MapboxCircle.__MONOSTATE.broadcast.emit("resumeCircleFillListeners", this._instanceId, typeOfHandle);
      }
      /**
      ...
      _onCenterHandleMouseDown() {
        ...
        this.map.once("mouseout", this._onCenterHandleMouseUpOrMapMouseOut);
        this._highlightHandles(this._circleCenterHandleId, "move");
      }
      /**
      ...
      _onRadiusHandlesMouseDown(event) {
        ...
        this.map.once("mouseout", this._onRadiusHandlesMouseUpOrMapMouseOut);
        this._highlightHandles(this._circleRadiusHandlesId, this._getRadiusHandleCursorStyle(event));
      }
      /**
      ...
      _onCircleFillContextMenu(event) {
        ...
        if (event.originalEvent.ctrlKey && _MapboxCircle._checkIfBrowserIsSafari()) {
      ...
      _bindBroadcastListeners() {
        _MapboxCircle.__MONOSTATE.broadcast.on("suspendCenterHandleListeners", this._onCenterHandleSuspendEvents);
        _MapboxCircle.__MONOSTATE.broadcast.on("resumeCenterHandleListeners", this._onCenterHandleResumeEvents);
        _MapboxCircle.__MONOSTATE.broadcast.on("suspendRadiusHandlesListeners", this._onRadiusHandlesSuspendEvents);
        _MapboxCircle.__MONOSTATE.broadcast.on("resumeRadiusHandlesListeners", this._onRadiusHandlesResumeEvents);
        _MapboxCircle.__MONOSTATE.broadcast.on("suspendCircleFillListeners", this._onCircleFillSuspendEvents);
        _MapboxCircle.__MONOSTATE.broadcast.on("resumeCircleFillListeners", this._onCircleFillResumeEvents);
      }
      /**
      ...
      _unbindBroadcastListeners() {
        _MapboxCircle.__MONOSTATE.broadcast.removeListener(
          "suspendCenterHandleListeners",
          this._onCenterHandleSuspendEvents
        );
        _MapboxCircle.__MONOSTATE.broadcast.removeListener(
          "resumeCenterHandleListeners",
          this._onCenterHandleResumeEvents
        );
        _MapboxCircle.__MONOSTATE.broadcast.removeListener(
          "suspendRadiusHandlesListeners",
          this._onRadiusHandlesSuspendEvents
        );
        _MapboxCircle.__MONOSTATE.broadcast.removeListener(
        ...
        _MapboxCircle.__MONOSTATE.broadcast.removeListener(
          ...
          this._onCircleFillSuspendEvents
        );
        _MapboxCircle.__MONOSTATE.broadcast.removeListener(
          "resumeCircleFillListeners",
          this._onCircleFillResumeEvents
        );
      }
      /**
      ...
      static _addActiveEditableCircle(circleObject) {
        _MapboxCircle.__MONOSTATE.activeEditableCircles.push(circleObject);
        _MapboxCircle.__MONOSTATE.broadcast.setMaxListeners(
          _MapboxCircle.__MONOSTATE.activeEditableCircles.length
        );
      }
      /**
      ...
      static _removeActiveEditableCircle(circleObject) {
        _MapboxCircle.__MONOSTATE.activeEditableCircles.splice(
          _MapboxCircle.__MONOSTATE.activeEditableCircles.indexOf(circleObject),
          1
        );
        _MapboxCircle.__MONOSTATE.broadcast.setMaxListeners(
          _MapboxCircle.__MONOSTATE.activeEditableCircles.length
      ...
      _getCenterHandleStrokeLayer() {
        if (this._centerDragActive && this.radius < 1e4) {
          ...
          const horizontalPixelsPerMeter = x / turfDistance(
            this.map.unproject([0, y]).toArray(),
            this.map.unproject([x, y]).toArray(),
            "meters"
          );
          return {
      ...
      addTo(map, before) {
        ...
        const addCircleAssetsOnMap = () => {
          ...
          if (this.options.editable) {
            ...
            _MapboxCircle._addActiveEditableCircle(this);
      ...
      remove() {
        ...
        if (this.options.editable) {
          ...
          _MapboxCircle._removeActiveEditableCircle(this);
...
lodash/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=mapbox-gl-circle.js.map
